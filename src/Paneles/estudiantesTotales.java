 ...
 */
public class estudiantesTotales extends javax.swing.JPanel {

    /**
     * Creates new form estudiantesTotales
     */
    ...
    public estudiantesTotales(String usuario, String tipo , Controlador controlador) throws SQLException {
    ...
    private void setTable(){
        DefaultTableModel modelo = controlador.usuarios("estudiantes");
    ...
    private void initComponents() {
        ...
        setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Total Estudiantes en la plataforma", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 14))); // NOI18N
        ...
        add(btnNuevo, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 30, 140, 40));
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 30, 570, 330));
        ...
        add(bntEditar, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 80, 140, 40));
        ...
        add(bntActualizar, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 130, 140, 40));
        ...
        add(bntEliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 180, 140, 40));
    ...
    private void bntEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntEditarActionPerformed
        ...
        if(fila>=0){
            String correo = tablaEstudiantes.getValueAt(fila,3).toString();
            crearUsuario editar;
            try {
                editar = new crearUsuario("actualizacion", correo,tipo,controlador);
    ...
    private void bntEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntEliminarActionPerformed
        ...
        int fila = tablaEstudiantes.getSelectedRow();
        if(fila>=0){
            int id = Integer.parseInt(tablaEstudiantes.getValueAt(fila,0).toString());
            String correo = tablaEstudiantes.getValueAt(fila,3).toString();
            try {
